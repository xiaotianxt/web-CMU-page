...
import aiOverviewData from "@/data/NFL-game/ai-overview.json"
...
export default function AiModePage() {
  ...
  const getImageForReference = (referenceIndex: number) => {
    return `/NFL-game/images/${referenceIndex+1}.jpeg`
  }
      ...
      <div className="flex">
        ...
        <div className="flex-1 flex">
          ...
          <div className="flex-1 px-8 py-8 max-w-4xl">
            ...
            <h1 className="text-3xl font-normal text-gray-900 mb-6">what is nfl games?</h1>
