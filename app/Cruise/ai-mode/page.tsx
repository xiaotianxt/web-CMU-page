...
import aiOverviewData from "@/data/Cruise/ai-overview.json"
...
export default function AiModePage() {
  ...
  const getImageForReference = (referenceIndex: number) => {
    return `/Cruise/images/${referenceIndex + 1}.jpeg`
  }
        ...
        <div className="flex-1 flex min-h-0">
          ...
          <div className="flex-1 flex flex-col max-w-4xl px-8 py-8 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto pr-2 min-h-0">
              ...
              Is there any popular recommendation for cruise choice?
              </h1>
                            ...
                            <div className="flex">
                              <div className="flex-1 p-2">
                                <h3 className="text-blue-700 hover:underline text-base font-medium">
                                  <TrackedLink componentName="AIMode" linkIndex={index} href={ref.link}>{ref.title}</Link>
                                </h3>
