    ...
    <div className="flex items-center justify-center py-8">
      <div className="flex items-center">
        ...
        <div className="flex space-x-2">
          ...
          <Link href="/3" className="flex items-center justify-center w-8 h-8 text-blue-600 hover:underline">
            3
          </Link>
          <Link href="/4" className="flex items-center justify-center w-8 h-8 text-blue-600 hover:underline">
            4
          </Link>
